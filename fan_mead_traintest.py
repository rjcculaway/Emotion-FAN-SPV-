...
def main():
    ...
    ''' Load data '''
    root_train = './data/face/train_mead'
    batchsize_train= 48
    root_eval = './data/face/eval_mead'
    batchsize_eval= 64
    train_loader, val_loader = load.mead_faces_fan(root_train, batchsize_train, root_eval, batchsize_eval)
    ''' Load model '''
    ...
    if args.evaluate == True:
        ...
        return
    logger.print('frame attention network (fan) mead dataset, learning rate: {:}'.format(args.lr))
